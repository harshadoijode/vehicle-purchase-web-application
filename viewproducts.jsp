...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname from product where category='"+request.getParameter("category")+"'and showroomname='"+session.getAttribute("sname")+"'  ");
while(rst.next()){
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid from product where showroomname='"+session.getAttribute("sname")+"' ");
while(rst.next()){
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid from product where productname like '%"+request.getParameter("pname")+"%' and showroomname='"+session.getAttribute("sname")+"' ");
while(rst.next()){
