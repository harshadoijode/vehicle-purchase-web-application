...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname,quantity from cars where productname like '%"+request.getParameter("pname")+"%'  ");
while(rst.next()){
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname,quantity from cars");
while(rst.next()){
