...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname,quantity from cars where category='"+request.getParameter("category")+"' ");
while(rst.next()){
   ...
   <div class="column">
    <div class="card" align="center"><center>
      ...
      <div class="container" align="center">
		...
		<h3>Quantity:<%= rst.getString(7) %></h3>
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid from cars where productname like '%"+request.getParameter("pname")+"%' ");
while(rst.next()){
