...
int x=stmt.executeUpdate("insert into cars(category,productname,productprice,quantity,image,description,showroomname) values('"+category +"','"+productname +"','"+productprice +"','"+quantity +"','"+image+"','"+desc+"','"+session.getAttribute("sname")+"')");
if(x!=0){
