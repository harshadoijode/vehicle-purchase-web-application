...
rst=stmt.executeQuery("select email from carowners where email='"+request.getParameter("email")+"' ");
if(rst.next()){
%>
...
<%
  ...
  %>
<script>alert("No showroom exist");</script>
<%
}
...
rst=stmt.executeQuery("select password from carowners where email='"+request.getParameter("email")+"' and  storemobileno='"+request.getParameter("answer")+"' ");
