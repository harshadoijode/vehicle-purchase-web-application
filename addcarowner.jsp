...
<div align="center" class="style1 style2">New Car Showroom Registration Form </div>
...
try{
int x=stmt.executeUpdate("insert into carowners(storename,address,storemobileno,password,email) values('"+s1+"','"+s2+"','"+s3+"','"+s4+"','"+s5+"')");
if(x!=0){
%>
<script>

alert("Showroom Registation Successfull");
window.open("addcarowner.jsp","_self");
</script>
<%
}
