...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname from product where category='"+request.getParameter("category")+"' ");
while(rst.next()){
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname from product ");
while(rst.next()){
...
rst=stmt.executeQuery("select productname,productprice,image,description,productid,showroomname from product where productname like '%"+request.getParameter("pname")+"%' ");
while(rst.next()){
