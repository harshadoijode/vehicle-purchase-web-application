...
<p align="center"><strong>  Showroom details</strong></p>
  ...
  rst=stmt.executeQuery("select * from showroom");
  while(rst.next()){
...
try{
int x=stmt.executeUpdate("update showroom set storename='"+request.getParameter("e2")+"',address='"+request.getParameter("e3")+"',storemobileno='"+request.getParameter("e4")+"',password='"+request.getParameter("e5")+"' where storeid='"+request.getParameter("e1")+"' ");
if(x!=0)
{
%>
<script>
alert("Date Updated");
window.open("viewshowroom.jsp","_self");
</script>
<%
...
try{
int x=stmt.executeUpdate("delete from showroom where storeid='"+request.getParameter("e1")+"'");
if(x!=0){
%>
<script>
...
try{
int x=stmt.executeUpdate("update showroom set status='Accept' where storeid='"+request.getParameter("e1")+"' ");
if(x!=0)
{
%>
<script>
...
try{
int x=stmt.executeUpdate("update showroom set status='Reject' where storeid='"+request.getParameter("e1")+"' ");
if(x!=0)
{
%>
<script>
