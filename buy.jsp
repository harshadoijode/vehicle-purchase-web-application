...
rst=stmt.executeQuery("select productname,productprice,quantity,productid,showroomname from product where productname='"+pname+"' ");
...
//float res=ch/100;
 ...
 // out.print("product  amount"+productAmt);
  ...
  <%  
	...
	int x=stmt.executeUpdate("insert into orderlist (productname,productCast,quantity,totalAmount,address,cardHolderName,cardtype,cardNum,cvv,showroom)values('"+t1+"','"+t2+"','"+t3 +"','"+t4+"','"+t5+"','"+t6+"','"+t7+"','"+t8+"','"+t9+"','"+t10+"')");
	if(x!=0){
